...
const Contact = ({ meta, }) => {
    return (
        <section ref={meta.content_ref} id={meta.name} className='odd:dark:bg-[#333] odd:bg-[#CCC] dark:bg-transparent bg-transparent z-10 m-0 h-max px-24 min-h-[100vh]'>
            <div className="flex align-middle items-center justify-start flex-col md:px-12 md:py-10 ">
                <div className='w-full h-max'>
                    <RevealFromLeft>
                        <h1 className='dark:text-white text-black text-5xl font-mono md:mt-16 mt-3'>Contact</h1>
                    </RevealFromLeft>
