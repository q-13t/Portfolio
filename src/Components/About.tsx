...
const About = ({ meta }) => {
    ...
    return (
        <section ref={meta.content_ref} id={meta.name} className='odd:dark:bg-[#333] odd:bg-[#CCC] dark:bg-transparent bg-transparent z-10 m-0 overflow-auto md:px-4 pl-[4rem] pr-[1rem]'>
            <div className="flex align-middle items-center justify-center flex-col md:px-12 md:py-10 h-full">
                <div className='w-full h-max'>
                    <RevealFromLeft>
                        <h1 className='dark:text-white text-black text-5xl font-mono md:my-5 my-3'>About</h1>
                    </RevealFromLeft>
